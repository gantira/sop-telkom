  ...
  <section class="section">
    ...
    <nav class="level">
      ...
      <div class="level-right">
        ...
        <nuxt-link class="level-item button is-success" :to="{name: 'admin-tags-create'}">New</nuxt-link>
      </div>
    </nav>
        ...
        <template v-if="selected">
          <nav class="level">
            ...
            <div class="level-right">
              <div class="level-item">
                <nuxt-link
                  :to="{name: 'admin-tags-id-edit', params: {id: selected.id}}"
...
export default {
  ...
  computed: {
    ...mapGetters("admin/tags", ["tags", "isLoading"])
  },
  ...
  methods: {
    ...
    async destroy() {
      this.$buefy.dialog.confirm({
        title: "Deleting tag",
        message:
          "Apakah Anda yakin ingin <b> menghapus </b> tag? Tindakan ini tidak bisa dibatalkan.",
        confirmText: "Delete Tag",
        type: "is-danger",
        hasIcon: true,
        onConfirm: () => {
          for (const item of this.checkedRows) {
            this.$store.dispatch("admin/tags/delete", item.id);
          }
          this.checkedRows = [];
          this.$buefy.toast.open("Tag deleted!");
        }
      });
    },
    find() {
      this.$store.dispatch("admin/tags/get", this.search);
    }
  }
};
</script>
